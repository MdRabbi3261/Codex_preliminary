...
_THIRD_PARTY_REPLACEMENTS_BN = [
    (r"এজেন্টের সাথে যোগাযোগ[^।]*।", "অনুগ্রহ করে এই অফিসিয়াল সাপোর্ট চ্যানেলে কথোপকথন চালিয়ে যান।"),
    (r"ব্যক্তিগত নম্বরে[^।]*।", "অনুগ্রহ করে এই অফিসিয়াল সাপোর্ট চ্যানেলে কথোপকথন চালিয়ে যান।"),
    (r"টেলিগ্রাম[^।]*।", "অনুগ্রহ করে এই অফিসিয়াল সাপোর্ট চ্যানেলে কথোপকথন চালিয়ে যান।"),
    (r"হোয়াটসঅ্যাপ[^।]*।", "অনুগ্রহ করে এই অফিসিয়াল সাপোর্ট চ্যানেলে কথোপকথন চালিয়ে যান।"),
]
